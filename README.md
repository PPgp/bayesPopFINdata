...
| pasfr | [12dq — Live births by sex, age of mother (5-year) and area, 1990–2025](https://pxdata.stat.fi/PXWeb/pxweb/en/StatFin/StatFin__synt/12dq.px) | Calculated from 5-year age groups, using monotone spline in [DemoTools package](https://timriffe.github.io/DemoTools/articles/graduation_with_demotools.html) |
